                        ...
                        ForEach(self.imageNameList.indices, id: \.self) { index in
                            if self.imageNameList.indices.contains(index) &&
                                ...
                                unitButtonScreenChoiceVer3(
                                    ...
                                    action: enen.bigScreenCountSumFunc
                                )
                            }
                        }
                    }
...
//                            title: self.sisaList[index],
    ...
    func bindingForScreenCount(index: Int) -> Binding<Int> {
        switch index {
        case 0: return $enen.bigScreenCountDefault
        case 1: return $enen.bigScreenCountHighJaku
        case 2: return $enen.bigScreenCountHighKyo
        case 3: return $enen.bigScreenCountOver4
        case 4: return $enen.bigScreenCountOver5
        case 5: return $enen.bigScreenCountOver6
