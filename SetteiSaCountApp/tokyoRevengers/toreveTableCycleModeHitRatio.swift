...
struct toreveTableCycleModeHitRatio: View {
    ...
    private func cycle1Percent(mode: String) -> [Double] {
        switch mode {
        case "モードA": return [34.4,34.8,35.2,35.5]
        case "モードB": return [9.8,10.2,10.5]
    ...
    private func cycle1Line(mode: String) -> [Int] {
        switch mode {
        case "モードA": return [3,1,1,1]
        case "モードB": return [1,3,2]
    ...
    private func cycle2Percent(mode: String) -> [Double] {
        switch mode {
        case "モードA": return [17.6,18.0,19.1,22.7,25.4,27.3]
        case "モードB": return [20.3]
    ...
    private func cycle3Percent(mode: String) -> [Double] {
        switch mode {
        case "モードA": return [29.3,29.7,30.9,37.5,39.8,44.9]
        case "モードB": return [52.3,52.7,53.1,53.5,53.9]
    ...
    private func cycle4Percent(mode: String) -> [Double] {
        switch mode {
        case "モードA": return [25,25.4,25.8,27,28.1,29.7]
        case "モードB": return [25,25.8,27,27.7]
        case "特殊": return [25]
        default: return [0,0,0,0,0,0]
        }
    }
    ...
    private func cycle5Percent(mode: String) -> [Double] {
        switch mode {
        case "モードA": return [33.2,33.6,34,34.8,35.9]
        case "モードB": return [33.2,33.6,34.4,35.2,35.9]
        case "特殊": return [17.6]
        default: return [0,0,0,0,0,0]
        }
    }
    private func cycle5Line(mode: String) -> [Int] {
        switch mode {
        case "モードA": return [2,1,1,1,1]
        case "モードB": return [2,1,1,1,1]
        case "特殊": return [6]
        default: return [1,1,1,1,1,1]
        }
    }
