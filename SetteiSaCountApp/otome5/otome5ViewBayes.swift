...
struct otome5ViewBayes: View {
    ...
    var body: some View {
        ...
        // //// バッジのリセット
        .resetBadgeOnAppear($common.otome5MenuBayesBadge)
        // //// firebaseログ
        .onAppear {
    ...
    private func bayesRatio() -> [Double] {
        // 乙女アタック当選率
        var logPostAttack: [Double] = [Double](repeating: 0, count: self.settingList.count)
        if self.attackEnable {
            logPostAttack = logPostPercentBino(
                ratio: otome5.ratioOtomeAttack,
