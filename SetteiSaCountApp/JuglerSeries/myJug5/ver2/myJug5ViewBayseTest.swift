...
//    @State var guessCustom1: [Int] = []
    @State var guessCustom1: [Int] = []
    @State var guessCustom2: [Int] = []
    @State var guessCustom3: [Int] = []
    @State var guessEvenly: [Int] = [1,1,1,1,1,1]
    let guessCustom1Key = "bayesTestGuessCustom1Key"
    let guessCustom2Key = "bayesTestGuessCustom2Key"
    let guessCustom3Key = "bayesTestGuessCustom3Key"
...
//                }
        ...
        .onAppear {
            ...
            self.guessCustom2 = decodeIntArrayFromString(stringData: self.guessCustom2JSON)
            self.guessCustom3 = decodeIntArrayFromString(stringData: self.guessCustom3JSON)
        }
    }
    ...
    func bayesRatioNew() -> [Double] {
        // BIGの対数尤度
        let logPostBig = logPostDenoBino(
...
//            var logPostListReg = [Double](repeating: 0, count: myJug5.denominateListRegSum.count)
        ...
        for (i, guess) in guessList.enumerated() {
            let beforeUpSum = guessList.reduce(0, +)
            let pBefore = Double(guess)/Double(beforeUpSum)
//            logPostListSum[i] = logPostListBig[i] + logPostListReg[i] + logPostListBell[i] + log(Double(guess)/Double(100))
            logPostListSum[i] = logPostListBig[i] + logPostListReg[i] + logPostListBell[i] + log(pBefore)
//            logPostListSum[i] = logPostListBig[i] + logPostListReg[i] + logPostListBell[i]
        }
...
//        return logPostListSum
//        let a: [Double] = [log(0.72)]
//        return a
    }
}
