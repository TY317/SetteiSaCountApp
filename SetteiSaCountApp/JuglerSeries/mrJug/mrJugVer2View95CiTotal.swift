...
struct mrJugVer2View95CiTotal: View {
    ...
    var body: some View {
        TabView(selection: $selection) {
                ...
                unitListSection95Ci(
                    ...
                    grafView: AnyView(
                        unitChart95CiDenominate(
                            currentCount: $mrJug.totalBellCount,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $mrJug.totalBigCount,
                        bigNumber: $mrJug.currentGames,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $mrJug.totalRegCount,
                        bigNumber: $mrJug.currentGames,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $mrJug.totalBonusCountSum,
                        bigNumber: $mrJug.currentGames,
...
#Preview {
    mrJugVer2View95CiTotal(mrJug: MrJug())
}
