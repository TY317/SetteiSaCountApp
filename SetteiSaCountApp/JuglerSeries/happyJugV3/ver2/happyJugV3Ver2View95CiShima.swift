//
//  happyJugV3Ver2View95CiShima.swift
//  SetteiSaCountApp
//
...
struct happyJugV3Ver2View95CiShima: View {
    ...
    var body: some View {
        TabView(selection: $selection) {
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $happyJugV3.shimaBigs,
                        bigNumber: $happyJugV3.shimaGames,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $happyJugV3.shimaRegs,
                        bigNumber: $happyJugV3.shimaGames,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $happyJugV3.shimaBonusSum,
                        bigNumber: $happyJugV3.shimaGames,
