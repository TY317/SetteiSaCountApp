//
//  happyJugV3Ver2ViewKenDataInput.swift
//  SetteiSaCountApp
//
...
//    @ObservedObject var happyJugV3 = HappyJugV3()
    ...
    var body: some View {
        List {
            Section {
                // ゲーム数入力
                unitTextFieldGamesInput(title: "ゲーム数", inputValue: $happyJugV3.kenGameIput)
                    .focused($isFocused)
                    .toolbar {
                ...
                // ビッグ回数
                unitTextFieldGamesInput(title: "BIG回数", inputValue: $happyJugV3.kenBigCountInput)
                    .focused($isFocused)
                // レギュラー回数
                unitTextFieldGamesInput(title: "REG回数", inputValue: $happyJugV3.kenRegCountInput)
                    .focused($isFocused)
                // ぶどう逆算トグルスイッチ
                Toggle("ぶどう逆算有効化", isOn: $happyJugV3.kenBackCalculationEnable)
                // //// 差枚数とぶどう逆算値
                if happyJugV3.kenBackCalculationEnable {
                    // 差枚数
                    unitTextFieldGamesInput(
                        title: "差枚数",
                        inputValue: $happyJugV3.kenCoinDifferenceInput,
                    ...
                    HStack {
                        ...
                        Text("\(happyJugV3.kenBellBackCalculationCount)")
                    ...
                    if orientation.isLandscape || (orientation.isFlat && lastOrientation.isLandscape) {
                        HStack {
                            ...
                            unitResultRatioDenomination2Line(
                                title: "ぶどう確率",
                                count: $happyJugV3.kenBellBackCalculationCount,
                            ...
                            unitResultRatioDenomination2Line(
                                title: "BIG確率",
                                count: $happyJugV3.kenBigCountInput,
                                bigNumber: $happyJugV3.kenGameIput,
                                numberofDicimal: 0,
                                spacerBool: false
                            )
                            ...
                            unitResultRatioDenomination2Line(
                                title: "REG確率",
                                count: $happyJugV3.kenRegCountInput,
                                bigNumber: $happyJugV3.kenGameIput,
                                numberofDicimal: 0,
                                spacerBool: false
                            )
                            ...
                            unitResultRatioDenomination2Line(
                                title: "ボーナス合算",
                                count: $happyJugV3.kenBonusCountSum,
                                bigNumber: $happyJugV3.kenGameIput,
                                numberofDicimal: 0,
                                spacerBool: false
                            )
