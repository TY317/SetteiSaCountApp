...
struct happyJugV3ViewBayes: View {
    ...
    let payoutList: [Double] = [97.0, 98.1, 99.9, 102.9, 105.8, 108.4]
        ...
        if self.bellEnable {
            ...
            if happyJugV3.startBackCalculationEnable {
                logPostBell = logPostDenoBino(
                    ratio: happyJugV3.denominateListBell,
