//
//  girlsSSVer2View95CiPersonal.swift
//  SetteiSaCountApp
//
    ...
    var body: some View {
        TabView(selection: $selection) {
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $girlsSS.personalBigCountSum,
                        bigNumber: $girlsSS.playGame,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $girlsSS.personalRegCountSum,
                        bigNumber: $girlsSS.playGame,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $girlsSS.personalBonusCountSum,
                        bigNumber: $girlsSS.playGame,
