//
//  girlsSSViewBayes.swift
//  SetteiSaCountApp
//
//  Created by 横田徹 on 2025/09/09.
//

import SwiftUI

struct girlsSSViewBayes: View {
//    @ObservedObject var ver391: Ver391
    @ObservedObject var girlsSS: GirlsSS
    
    // 機種ごとに見直し
    let settingList: [Int] = [1,2,3,4,5,6]   // その機種の設定段階
    let payoutList: [Double] = [97.0, 97.9, 99.9, 102.1, 104.0, 107.5]
...
//                }
        ...
        // //// バッジのリセット
//        .resetBadgeOnAppear($ver391.girlsSSMenuBayesBadge)
        // //// firebaseログ
        .onAppear {
        ...
        if self.bellEnable {
            ...
            if girlsSS.startBackCalculationEnable {
                logPostBell = logPostDenoBino(
                    ratio: girlsSS.denominateListBell,
