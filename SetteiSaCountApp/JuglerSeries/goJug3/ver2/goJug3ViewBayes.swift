...
struct goJug3ViewBayes: View {
    @ObservedObject var ver391: Ver391
    @ObservedObject var goJug3: GoJug3
    
    // 機種ごとに見直し
    let settingList: [Int] = [1,2,3,4,5,6]   // その機種の設定段階
    let payoutList: [Double] = [97.2, 98.2, 99.4, 101.6, 103.8, 106.5]
...
//                }
        ...
        // //// バッジのリセット
        .resetBadgeOnAppear($ver391.goJug3MenuBayesBadge)
        // //// firebaseログ
        .onAppear {
...
//                    ratio: goJug3.denominateListBigSum,
//                    Count: goJug3.startBigCountInput,
//                    bigNumber: goJug3.startGameInput,
//                )
//                // 単独Big分
//                let logPostBigAlone = logPostDenoBino(
//                    ratio: goJug3.denominateListBigAlone,
//                    Count: goJug3.personalAloneBigCount,
//                    bigNumber: goJug3.playGame,
//                )
//                // チェリーBig分
//                let logPostBigCherry = logPostDenoBino(
//                    ratio: goJug3.denominateListBigCherry,
//                    Count: goJug3.personalCherryBigCount,
//                    bigNumber: goJug3.playGame,
//                )
//                // 3つを合算する
...
//                    ratio: goJug3.denominateListRegSum,
//                    Count: goJug3.startRegCountInput,
//                    bigNumber: goJug3.startGameInput,
//                )
//                // 単独REG分
//                let logPostRegAlone = logPostDenoBino(
//                    ratio: goJug3.denominateListRegAlone,
//                    Count: goJug3.personalAloneRegCount,
//                    bigNumber: goJug3.playGame,
//                )
//                // チェリーREG分
//                let logPostRegCherry = logPostDenoBino(
//                    ratio: goJug3.denominateListRegCherry,
//                    Count: goJug3.personalCherryRegCount,
//                    bigNumber: goJug3.playGame,
//                )
//                // 3つを合算する
        ...
        if self.bellEnable {
            ...
            if goJug3.startBackCalculationEnable {
                logPostBell = logPostDenoBino(
                    ratio: goJug3.denominateListBell,
