...
struct goJug3Ver2View95CiStart: View {
    ...
    var body: some View {
        TabView(selection: $selection) {
                ...
                unitListSection95Ci(
                    ...
                    grafView: AnyView(
                        unitChart95CiDenominate(
                            currentCount: $goJug3.startBellBackCalculationCount,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $goJug3.startBigCountInput,
                        bigNumber: $goJug3.startGameInput,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $goJug3.startRegCountInput,
                        bigNumber: $goJug3.startGameInput,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $goJug3.startBonusCountSum,
                        bigNumber: $goJug3.startGameInput,
...
#Preview {
    goJug3Ver2View95CiStart(goJug3: GoJug3())
}
