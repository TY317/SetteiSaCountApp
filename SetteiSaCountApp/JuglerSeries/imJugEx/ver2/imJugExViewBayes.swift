...
struct imJugExViewBayes: View {
//    @ObservedObject var ver391: Ver391
    @ObservedObject var imJugEx: ImJugEx
    
    // 機種ごとに見直し
    let settingList: [Int] = [1,2,3,4,5,6]   // その機種の設定段階
    let payoutList: [Double] = [97.0, 98.0, 99.5, 101.1, 103.3, 105.5]
...
//                }
        ...
        // //// バッジのリセット
//        .resetBadgeOnAppear($ver391.imJugExMenuBayesBadge)
        // //// firebaseログ
        .onAppear {
...
//                    ratio: imJugEx.denominateListBigSum,
//                    Count: imJugEx.startBigCountInput,
//                    bigNumber: imJugEx.startGameInput,
//                )
//                // 単独Big分
//                let logPostBigAlone = logPostDenoBino(
//                    ratio: imJugEx.denominateListBigAlone,
//                    Count: imJugEx.personalAloneBigCount,
//                    bigNumber: imJugEx.playGame,
//                )
//                // チェリーBig分
//                let logPostBigCherry = logPostDenoBino(
//                    ratio: imJugEx.denominateListBigCherry,
//                    Count: imJugEx.personalCherryBigCount,
//                    bigNumber: imJugEx.playGame,
//                )
//                // 3つを合算する
        ...
        if self.bellEnable {
            ...
            if imJugEx.startBackCalculationEnable {
                logPostBell = logPostDenoBino(
                    ratio: [6.02,6.02,6.02,6.02,6.02,5.78],
