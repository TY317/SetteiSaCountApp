...
struct funky2Ver2View95CiTotal: View {
    ...
    var body: some View {
        TabView(selection: $selection) {
                ...
                unitListSection95Ci(
                    ...
                    grafView: AnyView(
                        unitChart95CiDenominate(
                            currentCount: $funky2.totalBellCount,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $funky2.totalBigCount,
                        bigNumber: $funky2.currentGames,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $funky2.totalRegCount,
                        bigNumber: $funky2.currentGames,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $funky2.totalBonusCountSum,
                        bigNumber: $funky2.currentGames,
...
#Preview {
    funky2Ver2View95CiTotal(funky2: Funky2())
}
