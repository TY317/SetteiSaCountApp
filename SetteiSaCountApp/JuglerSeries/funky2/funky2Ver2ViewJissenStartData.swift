//
//  funky2Ver2ViewJissenStartData.swift
//  SetteiSaCountApp
//
...
//    @ObservedObject var funky2 = Funky2()
    ...
    var body: some View {
        List {
            Section {
                // ゲーム数入力
                unitTextFieldGamesInput(title: "ゲーム数", inputValue: $funky2.startGameInput)
                    .focused($isFocused)
                    .toolbar {
                ...
                // ビッグ回数
                unitTextFieldGamesInput(title: "BIG回数", inputValue: $funky2.startBigCountInput)
                    .focused($isFocused)
                // レギュラー回数
                unitTextFieldGamesInput(title: "REG回数", inputValue: $funky2.startRegCountInput)
                    .focused($isFocused)
                // ぶどう逆算トグルスイッチ
                Toggle("ぶどう逆算有効化", isOn: $funky2.startBackCalculationEnable)
                // //// 差枚数とぶどう逆算値
                if funky2.startBackCalculationEnable {
                    // 差枚数
                    unitTextFieldGamesInput(
                        title: "差枚数",
                        inputValue: $funky2.startCoinDifferenceInput,
                    ...
                    HStack {
                        ...
                        Text("\(funky2.startBellBackCalculationCount)")
                    ...
                    if orientation.isLandscape || (orientation.isFlat && lastOrientation.isLandscape) {
                        HStack {
                            ...
                            unitResultRatioDenomination2Line(
                                title: "ぶどう確率",
                                count: $funky2.startBellBackCalculationCount,
                            ...
                            unitResultRatioDenomination2Line(
                                title: "ボーナス合算",
                                count: $funky2.startBonusCountSum,
                                bigNumber: $funky2.startGameInput,
                                numberofDicimal: 0,
                                spacerBool: false
                            )
...
//                    .popoverTip(tipUnitButtonLink95Ci())
        ...
        .toolbar {
            ToolbarItem(placement: .automatic) {
                HStack {
                    // /// リセット
                    unitButtonReset(isShowAlert: $isShowAlert, action: funky2.resetStartData)
