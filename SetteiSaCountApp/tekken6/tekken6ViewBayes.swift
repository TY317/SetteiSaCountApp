...
struct tekken6ViewBayes: View {
    ...
    var body: some View {
        ...
        // //// バッジのリセット
        .resetBadgeOnAppear($common.tekken6MenuBayesBadge)
        // //// firebaseログ
        .onAppear {
