//
//  draHanaSenkohVer2View95CiTotal.swift
//  SetteiSaCountApp
//
    ...
    var body: some View {
        TabView(selection: $selection) {
                ...
                unitListSection95Ci(
                    ...
                    grafView: AnyView(
                        unitChart95CiDenominate(
                            currentCount: $draHanaSenkoh.totalBellCount,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $draHanaSenkoh.totalBigCount,
                        bigNumber: $draHanaSenkoh.currentGames,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $draHanaSenkoh.totalRegCount,
                        bigNumber: $draHanaSenkoh.currentGames,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $draHanaSenkoh.totalBonusCountSum,
                        bigNumber: $draHanaSenkoh.currentGames,
