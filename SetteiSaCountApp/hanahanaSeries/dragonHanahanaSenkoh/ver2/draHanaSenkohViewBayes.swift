    ...
    private func bayesRatio() -> [Double] {
        ...
        if self.bigEnable {
            logPostBig = logPostDenoBino(
                ratio: draHanaSenkoh.denominateListBig,
        ...
        if self.regEnable {
            logPostReg = logPostDenoBino(
                ratio: draHanaSenkoh.denominateListReg,
        ...
        if self.bellEnable {
            ...
            if draHanaSenkoh.startBackCalculationEnable {
                logPostBell = logPostDenoBino(
                    ratio: draHanaSenkoh.denominateListBell,
        ...
        if self.bbSuikaEnable {
            logPostBigSuiKa = logPostDenoBino(
                ratio: draHanaSenkoh.denominateListBbSuika,
        ...
        if self.bigLampEnable {
            logPostBigLamp = logPostPercentMulti(
                countList: [
                    draHanaSenkoh.bbLampBCount,
                    draHanaSenkoh.bbLampYCount,
                    draHanaSenkoh.bbLampGCount,
                    draHanaSenkoh.bbLampRCount,
                ], ratioList: [
        ...
        if self.regSideLampEnable {
            logPostRegLamp = logPostPercentMulti(
                countList: [
                    draHanaSenkoh.rbLampBCount,
                    draHanaSenkoh.rbLampYCount,
                    draHanaSenkoh.rbLampGCount,
                    draHanaSenkoh.rbLampRCount,
                ], ratioList: [
                    [36,23,33,22,31,25],
                    [24,35,22,32,21,25],
                    [24,17,27,18,29,25],
