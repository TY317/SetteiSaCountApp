...
//    @ObservedObject var ver391: Ver391
    ...
    let payoutList: [Double] = [97.0, 99.0, 101.0, 103.0, 106.0, 109.0]
    ...
    private func bayesRatio() -> [Double] {
        ...
        if self.bigEnable {
            logPostBig = logPostDenoBino(
                ratio: hanaTensho.denominateListBig,
        ...
        if self.regEnable {
            logPostReg = logPostDenoBino(
                ratio: hanaTensho.denominateListReg,
        ...
        if self.bellEnable {
            ...
            if hanaTensho.startBackCalculationEnable {
                logPostBell = logPostDenoBino(
                    ratio: hanaTensho.denominateListBell,
        ...
        if self.bbSuikaEnable {
            logPostBigSuiKa = logPostDenoBino(
                ratio: hanaTensho.denominateListBbSuika,
        ...
        if self.bigLampEnable {
            logPostBigLamp = logPostPercentMulti(
                countList: [
                    hanaTensho.bbLampBCount,
                    hanaTensho.bbLampYCount,
                    hanaTensho.bbLampGCount,
                    hanaTensho.bbLampRCount,
                ], ratioList: [
        ...
        if self.regSideLampEnable {
            logPostRegLamp = logPostPercentMulti(
                countList: [
                    hanaTensho.rbLampBCount,
                    hanaTensho.rbLampYCount,
                    hanaTensho.rbLampGCount,
                    hanaTensho.rbLampRCount,
                ], ratioList: [
                    [36,23,33,22,31,25],
                    [24,35,22,32,21,25],
                    [24,17,27,18,29,25],
