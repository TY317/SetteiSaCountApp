//
//  hanaTenshoVer2View95CiTotal.swift
//  SetteiSaCountApp
//
...
struct hanaTenshoVer2View95CiTotal: View {
    ...
    var body: some View {
        TabView(selection: $selection) {
                ...
                unitListSection95Ci(
                    ...
                    grafView: AnyView(
                        unitChart95CiDenominate(
                            currentCount: $hanaTensho.totalBellCount,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $hanaTensho.totalBigCount,
                        bigNumber: $hanaTensho.currentGames,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $hanaTensho.totalRegCount,
                        bigNumber: $hanaTensho.currentGames,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $hanaTensho.totalBonusCountSum,
                        bigNumber: $hanaTensho.currentGames,
...
#Preview {
    hanaTenshoVer2View95CiTotal(hanaTensho: HanaTensho())
}
