//
//  kingHanaVer2View95CiTotal.swift
//  SetteiSaCountApp
//
...
struct kingHanaVer2View95CiTotal: View {
    ...
    var body: some View {
        TabView(selection: $selection) {
                ...
                unitListSection95Ci(
                    ...
                    grafView: AnyView(
                        unitChart95CiDenominate(
                            currentCount: $kingHana.totalBellCount,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $kingHana.totalBigCount,
                        bigNumber: $kingHana.currentGames,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $kingHana.totalRegCount,
                        bigNumber: $kingHana.currentGames,
            ...
            unitListSection95Ci(
                ...
                grafView: AnyView(
                    unitChart95CiDenominate(
                        currentCount: $kingHana.totalBonusCountSum,
                        bigNumber: $kingHana.currentGames,
...
#Preview {
    kingHanaVer2View95CiTotal(kingHana: KingHana())
}
