            ...
            List {
                ...
                // //////////////////////
                    ...
                    Section {
                        ...
                        // フェザーランプの参考情報リンク
                        unitLinkButton(title: "REG後のフェザーランプについて", exview: AnyView(unitExView5body2image(title: "REG後のフェザーランプ確率", textBody1: "・色によって設定を否定", image1: Image("kingHanaAfterRegLampAnalysis"))))
                        // 95%信頼区間グラフ
